...
import BlackScholes from '../visualizations/finance/BlackScholes';
import Markowitz from '../visualizations/finance/Markowitz';
import BinomialTree from '../visualizations/finance/BinomialTree';
import RandomWalk from '../visualizations/finance/RandomWalk';
import VaRSimulator from '../visualizations/finance/VaRSimulator';
...
const COMPONENTS = {
  ...
  'brownian-motion': RandomWalk,
  'var-simulator': VaRSimulator,
};
...
export default function Finance() {
  ...
  const section = SECTION_MAP['finance'];
  ...
  return (
    <main className="bg-white min-h-screen">
      {/* Hero */}
      <section className="domain-header py-16 px-6" aria-label="Finance section">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-blue-100 mb-6 max-w-2xl leading-relaxed">
            Price options with Black-Scholes, optimize portfolios on the efficient frontier,
            and simulate Brownian motion — the mathematics of markets.
          </p>
          <div className="inline-flex items-center gap-3 bg-[#F0F0F0] rounded-xl px-5 py-3 shadow-sm">
            <span className="text-[#4A4A4A] font-mono text-sm">
              <MathText math="C = S_0 N(d_1) - Ke^{-rT}N(d_2)" />
            </span>
            <span className="text-[#4A4A4A] text-xs font-medium border-l border-[#4A4A4A]/20 pl-3">Black-Scholes Call</span>
          </div>
        </div>
      </section>
